...
```bash
# Go to URL
python .qwen/skills/browsing-with-playwright/scripts/mcp-client.py call -u http://localhost:8808 -t browser_navigate \
  -p '{"url": "https://example.com"}'

# Go back
python .qwen/skills/browsing-with-playwright/scripts/mcp-client.py call -u http://localhost:8808 -t browser_navigate_back -p '{}'
```
...
python .qwen/skills/browsing-with-playwright/scripts/mcp-client.py call -u http://localhost:8808 -t browser_snapshot -p '{}'

# Screenshot
python .qwen/skills/browsing-with-playwright/scripts/mcp-client.py call -u http://localhost:8808 -t browser_take_screenshot \
...
```bash
# Click element
python .qwen/skills/browsing-with-playwright/scripts/mcp-client.py call -u http://localhost:8808 -t browser_click \
  -p '{"element": "Submit button", "ref": "e42"}'

# Type text
python .qwen/skills/browsing-with-playwright/scripts/mcp-client.py call -u http://localhost:8808 -t browser_type \
  -p '{"element": "Search input", "ref": "e15", "text": "hello world", "submit": true}'

# Fill form (multiple fields)
python .qwen/skills/browsing-with-playwright/scripts/mcp-client.py call -u http://localhost:8808 -t browser_fill_form \
  -p '{"fields": [{"ref": "e10", "value": "john@example.com"}, {"ref": "e12", "value": "password123"}]}'

# Select dropdown
python .qwen/skills/browsing-with-playwright/scripts/mcp-client.py call -u http://localhost:8808 -t browser_select_option \
...
python .qwen/skills/browsing-with-playwright/scripts/mcp-client.py call -u http://localhost:8808 -t browser_wait_for \
  -p '{"text": "Success"}'
...
```bash
python .qwen/skills/browsing-with-playwright/scripts/mcp-client.py call -u http://localhost:8808 -t browser_evaluate \
...
```bash
python .qwen/skills/browsing-with-playwright/scripts/mcp-client.py call -u http://localhost:8808 -t browser_run_code \
...
Run: `python .qwen/skills/browsing-with-playwright/scripts/verify.py`
...
3. Try: `bash .qwen/skills/browsing-with-playwright/scripts/start-server.sh`
...
| Server not responding | Stop and restart: `bash .qwen/skills/browsing-with-playwright/scripts/stop-server.sh && bash .qwen/skills/browsing-with-playwright/scripts/start-server.sh` |
