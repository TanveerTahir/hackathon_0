...
inputs and creating actionable markdown files for Claude to process.
"""
                ...
                try:
                    ...
                    for item in items:
                        try:
                            ...
                            self.log_activity(f"Error creating action file: {e}", "error")
                    
                except Exception as e:
                    self.logger.error(f"Error in check loop: {e}")
                    self.log_activity(f"Error in check loop: {e}", "error")
