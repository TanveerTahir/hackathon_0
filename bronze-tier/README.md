...
A comprehensive implementation of the Bronze Tier Digital FTE (Full-Time Equivalent) system - an AI agent that proactively manages personal and business affairs using Claude Code as the reasoning engine and Obsidian as the knowledge dashboard.
...
| **Action** | Claude Code + MCP | Execute approved actions |
...
4. **Configure Claude Code** (optional)
   - Copy skills to Claude Code skills folder:
     ```bash
